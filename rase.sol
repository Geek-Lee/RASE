...
contract EverRase is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xC281a3418f20ae259F2Fa58AA9F5Db2071B73c91); // Marketing Address
    ...
    string private _name = "EverRase";
    string private _symbol = "RASE";
